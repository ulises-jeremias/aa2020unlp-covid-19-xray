...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Generate splits for datasets")
    ...
    # flags
    parser.add_argument("-w", help="Store new dataset based on generated splits",
                        dest="write_dataset", action="store_true")
    ...
    parser.add_argument("--no-gs", dest="generate_splits",
                        action="store_false")
